...
def welcome():
    print ("Welcome to the SiGhence room and your job is to navigate your way through by winning this classic game of Minesweepers. ")
    print ("Teenagers leave a lot of garbage behind, but there isn't ")
...
#function to find out what bombs are nearby
